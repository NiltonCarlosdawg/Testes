...
export default function SignUpForm() {
  ...
  const validateField = (name: string, value: string): string => {
    if (name === "primeiroNome" || name === "ultimoNome") {
      if (!value.trim()) return `${name === "primeiroNome" ? "Primeiro" : "Último"} nome é obrigatório`;
      if (value.length < 2) return `Deve ter pelo menos 2 caracteres`;
    }
    if (name === "email") {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newErrors: Errors = {
      primeiroNome: validateField("primeiroNome", formData.primeiroNome),
      ultimoNome: validateField("ultimoNome", formData.ultimoNome),
    ...
    if (!isChecked) {
      toast.error("Você deve concordar com os termos");
      return;
    }
    ...
    const payload = {
      ...
      telefone: "",
      avatarUrl: "",
      roleId: "019a0c76-c6e4-736e-995b-c90b66af9305",
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="sm:col-span-1">
                    ...
                    />
                    {errors.primeiroNome && <p className="mt-1 text-sm text-red-500">{errors.primeiroNome}</p>}
                  </div>
                  <div className="sm:col-span-1">
                    <Label>
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                    />
                    {errors.ultimoNome && <p className="mt-1 text-sm text-red-500">{errors.ultimoNome}</p>}
                  </div>
                </div>
                <div>
                  <Label>
