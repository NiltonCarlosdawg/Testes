...
const Page = async ({ params }: { params: Promise<{ number: string }> }) => {
  ...
  return (
    <div>
      <div className="flex flex-wrap items-end gap-4">
        <div>
          <p className="mb-1 text-sm">
            <span className="text-neutral-500 dark:text-neutral-400">Pedido feito</span>
            <time dateTime="2021-03-22"> {order.date}</time>
          </p>
          <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">Pedido #{order.number}</h1>
        </div>
      ...
      {/* Products */}
      <div className="mt-6">
        <h2 className="sr-only">Produtos adquiridos</h2>
          ...
          {products.map((product) => (
            <div key={product.id} className="border-t border-b bg-white sm:rounded-lg sm:border dark:bg-neutral-800">
              <div className="py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
                ...
                <div className="mt-6 lg:col-span-5 lg:mt-0">
                  <dl className="grid grid-cols-2 gap-x-6 text-sm">
                    <div>
                      <dt className="font-medium">Endereço de entrega</dt>
                    ...
                    <div>
                      <dt className="font-medium">Atualizações de envio</dt>
              ...
              <div className="border-t px-4 py-6 sm:px-6 lg:p-8">
                <h4 className="sr-only">Estado</h4>
                ...
                <div aria-hidden="true" className="mt-6">
                  ...
                  <div className="mt-6 hidden grid-cols-4 text-sm font-medium text-neutral-500 sm:grid">
                    <div className="text-neutral-950 dark:text-white">Pedido feito</div>
      ...
      {/* Billing */}
      <div className="mt-16">
        <h2 className="sr-only">Resumo de cobrança</h2>
        ...
        <div className="bg-neutral-50 px-4 py-6 sm:rounded-lg sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8 lg:py-8 dark:bg-neutral-800">
          <dl className="grid grid-cols-2 gap-6 text-sm sm:grid-cols-2 md:gap-x-8 lg:col-span-7">
            <div>
              <dt className="t font-medium">Endereço de Cobrança</dt>
              <dd className="mt-3 text-neutral-500 dark:text-neutral-400">
            ...
            <div>
              <dt className="font-medium">Informações de pagamento</dt>
          ...
          <dl className="mt-8 flex flex-col gap-y-5 text-sm lg:col-span-5 lg:mt-0">
            ...
            <div className="flex items-center justify-between">
              <dt className="text-neutral-600 dark:text-neutral-300">Envio</dt>
              <dd className="font-medium">$5</dd>
            </div>
            <div className="flex items-center justify-between">
              <dt className="text-neutral-600 dark:text-neutral-300">Taxa</dt>
