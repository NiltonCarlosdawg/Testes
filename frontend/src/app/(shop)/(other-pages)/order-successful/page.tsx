    ...
    <>
      <main className="container">
        <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-3xl">
          <div>
            <p className="text-xs font-medium uppercase">Obrigado por encomendar</p>
            <Heading className="mt-4">Pagamento Concluido!</Heading>

            <p className="mt-2.5 max-w-2xl text-neutral-500">
              Agradecemos seu pedido, estamos processando-o neste momento. Aguarde um instante e enviaremos a confirmação em breve!

            </p>

            <dl className="mt-16 text-sm">
              <dt className="text-neutral-500">Número de Rastreamento</dt>
              <dd>
            ...
            <dl className="mt-12 grid grid-cols-2 gap-x-4 text-sm text-neutral-600 sm:mt-16 dark:text-neutral-300">
              <div>
                <dt className="font-medium text-neutral-900 uppercase">Endereço de Envio</dt>
                <dd className="mt-2">
              ...
              <div>
                <dt className="font-medium uppercase">Informações de Pagamento</dt>
                <dd className="mt-2 space-y-2 sm:flex sm:space-y-0 sm:gap-x-4">
                  ...
                  <div className="flex-auto uppercase">
                    <p className="">Terminando com 4242</p>
                    <p>Expires 12 / 21</p>
                  </div>
                </dd>
              </div>
